...
function App() {
  ...
  return (
    <Wrapper>
      <Helmet defaultTitle={"Avyansh Ralph"} titleTemplate={"%s • Avi"} />
      {shouldPlayIntro ? (
        ...
        >
          <ProgressContainer onClick={onIntroEnd}>
            <h4>
              Why skip this? <ChevronsRight />
            </h4>
          </ProgressContainer>
          <SuccessiveType
            onEnd={onIntroEnd}
            words={
              "Life is like a loop, you do the same thing over and over again... I code on a daily basis and only a bug can stop this loop which is no where possible because I am cloudflare protected..."
            }
            speed={1}
          ...
          <ContentWrapper>
            <AnimatePresence>
              <Switch>
                ...
                <Route exact path="/rickroll" component={Sakurajima} />
              </Switch>
            </AnimatePresence>
          </ContentWrapper>
        </Router>
