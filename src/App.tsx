...
function App() {
  ...
  return (
    <Wrapper>
      <Helmet defaultTitle={'Avyansh Ralph'} titleTemplate={'%s • Avyansh'} />
      {shouldPlayIntro ? (
        ...
        >
          ...
          <SuccessiveType
            onEnd={onIntroEnd}
            words={
              "Programming isn't about what you know; it's about what you can figure out. If you code on a daily basis, it's a loop, but if not then there is a test 4 problem."
            }
            speed={1}
