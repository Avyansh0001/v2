      ...
      <Container openOnMobile={openOnMobile}>
        ...
        <Items>
          ...
          <Row>
            <Location
              target="_blank"
              href={doing ? `https://www.google.com/maps/search/London%2C%20UK` : undefined}
              rel="noreferrer"
            >
              <NavigationIcon />
              {doing?.kv.location ? (
          ...
          <div ref={dragConstraintsRef}>
            ...
            <Page active={pathname === '/juicewrld' ? 1 : 0} to="/juicewrld">
              JW
            </Page>
          </div>
          ...
          <Icons>
            ...
            <a href="https://github.com/Avyansh0001">
              <GitHubLogo />
            </a>
            <a href="https://keybase.io/Avyansh">
              <KeyIcon />
            </a>
          </Icons>
          <Doing
